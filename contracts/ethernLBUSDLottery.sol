...
// File: contracts/ethernLLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title ethernL Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract ethernLLottery is ReentrancyGuard, IethernLLottery, Ownable {
    ...
    uint256 public constant MAX_TREASURY_FEE = 300; // 30%
